                                            ...
                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                <tr>
                                                    <td style="padding: 20px; font-family: Nunito; font-size: 15px; line-height: 20px; color: #555555;">
                                                        ...
                                                        <p style="margin: 0;">Bienvenido ${centroe_nuevo.nombre} ${centroe_nuevo.papellido}. Hemos recibido su registro y agradecemos la confianza. Está a un solo paso de unirse.</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td style="padding: 20px; font-family: Nunito; font-size: 15px; line-height: 20px; color: #555555;">
                                                        ...
                                                        <ul style="padding: 0; margin: 0 0 10px 0; list-style-type: disc;">
                                                            ...
                                                            <li style="margin:0 0 10px 30px; font-weight: bold; font-family: Nunito;">Clave temporal ${centroe_nuevo.clave}.</li>
